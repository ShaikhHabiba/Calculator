...
function showSelectedOperator(){
    ...
    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#c671ba";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#c671ba";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#c671ba";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#c671ba";
    }
}
